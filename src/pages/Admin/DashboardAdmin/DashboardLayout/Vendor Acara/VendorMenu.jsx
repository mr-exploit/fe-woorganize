...
const VendorMenu = () => {
    ...
    const [vendors, setVendors] = useState([
        ...
        { id: 2, name: 'Vendor 2', photo: '../src/assets/images/profile-medium.png', email: 'vendor2@example.com', location: 'Nusa Tenggara Timur', phone: '08xxxx', price: 'Rp. -', category: 'Acara' },
        { id: 3, name: 'Vendor 3', photo: '../src/assets/images/profile-medium.png', email: 'vendor3@example.com', location: 'Kupang', phone: '08xxxx', price: 'Rp. -', category: 'Acara' },
        { id: 4, name: 'Vendor 4', photo: '../src/assets/images/profile-medium.png', email: 'vendor4@example.com', location: 'Sumatra Utara', phone: '08xxxx', price: 'Rp. -', category: 'Dekorasi' },
        { id: 5, name: 'Vendor 5', photo: '../src/assets/images/profile-medium.png', email: 'vendor5@example.com', location: 'Jawa Tengah', phone: '08xxxx', price: 'Rp. -', category: 'Konsumsi' },
        { id: 6, name: 'Vendor 6', photo: '../src/assets/images/profile-medium.png', email: 'vendor6@example.com', location: 'Sumatra Barat', phone: '08xxxx', price: 'Rp. -', category: 'Dekorasi' },
    ]);
    ...
    const currentVendors = vendors.slice((currentPage - 1) * vendorsPerPage, currentPage * vendorsPerPage);
